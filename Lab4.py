...
class databaseService:
    def __init__(self, dbName, tableName):
        self.dbName = dbName #make into paramters
        self.tableN = tableName #make into paramters
...
class agent():
    ...
    def getData(self, sqliteConnection, column, rang=[]):
        #put lock so only one agent can access database at a time
        #data from 1990-2019 for respective Global Radiative Force
        #release the lock for next thread
