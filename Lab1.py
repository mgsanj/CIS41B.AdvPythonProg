...
class OutputStream:
    ...
    def __str__(self):
        ...
        try:
            ...
            string = ""
            if self.table == "CO2":
                string += "Total Carbon Emissions (in million metric tons of C):\nyear    average\n"
            elif self.table == "SeaLevel":
                string += "NOAA Mean Sea Level Rise (66S to 66N) using TOPEX/Poseidon, Jason-1, Jason-2, Jason-3:\nyear    average\n"
